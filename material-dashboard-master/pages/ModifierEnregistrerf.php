...
<?php
$con = mysqli_connect('localhost', 'root', '') or die("erreur1 ");
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="#" target="_blank">
                <img src="../../images/logo-ndlp.png" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-info text-white" href="../pages/tables.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
                        <span class="nav-link-text ms-1">Formations & personnel</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-white active bg-info text-white" href="../pages/tables.html">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">table_view</i>
                        </div>
...
<form class="row g-3" action="ModifierEnregistrerf.php" method="POST">
     <div class="col-12">
      <label for="inputAddress" class="form-label">Nom du formateur :</label>
      <input type="text" name="nom" class="form-control" id="inputAddress" placeholder="nom">
    </div>
    <div class="col-12">
    <label for="inputEmail4" class="form-label">Prénom du Formateur :</label>
  ...
  <div class="col-md-4">
    <label for="inputState" class="form-label">Formations</label>
    <select id="inputState" class="form-select">
      <option selected>Choisir...</option>
      <?php 
        while($lign=mysqli_fetch_array($res)){
            echo '<option>'.$lign["nom"].'</option><br/>';
